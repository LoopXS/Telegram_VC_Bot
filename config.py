...
if HEROKU:
    ...
    API_ID = int(environ["3208228"])
    API_HASH = environ["07d1d53a608693a6be436ca387582d8b"]
    SESSION_STRING = environ[
        "BAC9zP2iEJPhVbwObLX_Tok35cYm4h5v9gfZUqhB_jFwZ-3JdbCJIdDqSefYGnX3pMuDnIjqrw6N65PfbhLv93GGFuq4Zo6aTrB36li50z3hoEKQ0SEsYTAQ7e-o6yYzHxidMf8nSJdfUpRCzaTC6iW3sPqE7AZRtuG4tWX4ZD7tSns7kCVVw7A2H-16TxYExSEo_EDxvIeUXhZLeLsSZkYVVj-zc_VPKTgVqPqOSiUoSrCf70M3SDwGI90VE0JtHXyWHoNhKsv_WWaxaWRH6uulSObsceWGTP0b2xplyo2tE-QQ9k6YN9zQWEtURBJOXhjJucvqiUBQW1PZSEegml3RaWzUjQA"
    ]  # Check Readme for session
    ARQ_API_KEY = environ["VZPWJD-GKFGNQ-ICATFM-LKISYR-ARQ"]
    CHAT_ID = int(environ["-1001500995042"])
